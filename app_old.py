...
# Fonction pour générer une fiche de révision
def generate_revision_sheet():
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system",
         "Tu es un assistant pédagogique expert. À partir des documents fournis, génère une fiche de révision complète et structurée en markdown. La fiche doit contenir : "
...
@app.route("/generate_revision_sheet", methods=["POST"])
